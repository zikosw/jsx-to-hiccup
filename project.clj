(defproject hiccup-gen "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "hiccup-gen.core/on-js-reload"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/hiccup_gen.js"
                           :output-dir "resources/public/js/compiled/"
                           :source-map "resources/public/js/compiled/hiccup_gen.js.map"
