(defproject jsx-to-hiccup "0.1.0-SNAPSHOT"
  ...
  {:server {:clean-targets ["target"]}
   ...
   [:server
    {:npm {:package {:main "target/out/jsx-to-hiccup.js"
                     :scripts {:start "node target/out/jsx-to-hiccup.js"}}}
     ...
     {:builds {:dev
               {:source-paths ["env/dev" "src/server"]
                :figwheel     true
                :compiler     {:main          jsx-to-hiccup.app
                               :output-to     "target/out/jsx-to-hiccup.js"
    ...
    {:builds
     {:test
      {:source-paths ["env/test" "src/server" "test"]
       :compiler     {:main jsx-to-hiccup.app
                      :output-to     "target/test/jsx-to-hiccup.js"
                      :target        :nodejs
                      :optimizations :none
                      :pretty-print  true
                      :source-map    true}}}}
   ...
   :release
   {:npm {:package {:main "target/release/jsx-to-hiccup.js"
                    :scripts {:start "node target/release/jsx-to-hiccup.js"}}}
    :cljsbuild
    {:builds
     {:release
      {:source-paths ["env/prod" "src/server"]
       :compiler     {:main          jsx-to-hiccup.app
                      :output-to     "target/release/jsx-to-hiccup.js"
